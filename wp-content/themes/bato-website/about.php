...
<main id="primary" class="site-main">
    ...
    <?php if(!empty($section_our_story)) { ?>
        ...
        <section class="section-about-our-story">
            <div class="main-size">
                <div class="section-about-our-story__wrapper">
                    <div class="section-about-our-story__content">
                        ...
                        <?php if(!empty($our_story_text)) { ?>
                            ...
                            <div class="section-about-hero__text"><?php echo $our_story_text ?></div>
    ...
    <?php if(!empty($about_team_team)) { ?>
        ...
        <section class="section-team section-about-team" id="section-team">
    ...
    <?php if(!empty($about_hq_text)) { ?>
        ...
        <section class="section-about-hq">
            <div class="main-size">
    ...
    <?php if(!empty($about_family_images) || !empty($about_family_title)) { ?>
        ...
        <section class="section-about-family">
            <div class="main-size">
    ...
    <?php if(!empty($about_reviews)) { ?>
        ...
        <section class="section-about-reviews">
            <div class="main-size">
    ...
    <?php if(!empty($about_ready)) { ?>
        ...
        <section class="section-about-ready">
            <div class="main-size">
