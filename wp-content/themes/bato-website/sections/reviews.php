    ...
    <div class="section-about-reviews__pin-section">
        ...
        <div class="main-size">
            <div class="section-about-reviews__wrapper">
                ...
                <?php if (!empty($text)) : ?>
                    <div class="section-about-reviews__text"><?php echo $text ?></div>
                <?php endif ?>
                
                <?php if (!empty($rating)) : ?>

                    <a href="<?php echo $rating['link']['url'] ?>" class="section-about-reviews__rating">

                        <?php if (!empty($rating['logo'])) : ?>
                            <div class="section-about-reviews__rating-image">
                                <img src="<?php echo $rating['logo']['url'] ?>" alt="<?php echo $rating['logo']['name'] ?>" loading="lazy">
                            </div>
                        <?php endif ?>
